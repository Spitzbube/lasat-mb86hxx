...
static Graphic_Job_2_5_Item menu_channel_list_graphic_items[] = //234ea5f8
{
	{0}, //[0] = 234ea5f8 
...
static Graphic_Job_2_5 menu_channel_list_graphic_data = //234eabf8
{
	0, //uint8_t bData_0; //0
	0xfa, //uint8_t bData_1; //1
	0x000b, //uint16_t wData_2; //2
	0x04, //uint8_t bData_4; //4
	&menu_channel_list_graphic_items[0], //Graphic_Job_2_5_Item* pItems; //8
...
static Menu_Item menu_channel_list_items[] = //234eac40
{
	//[0]
	{
		...
		{
			&menu_channel_list_graphic_items[5], //234ea738,
		}, //int fill_4[5]; //4
...
0x234eac60                        dd         menu_event_thread+1
	...
	//[1]
	{
		...
		0xffff, //uint16_t wData_2; //2
		{
			&menu_channel_list_graphic_items[6], //234ea778,
		}, //int fill_4[5]; //4
		0, //void (*initValueString)(struct Menu_Item*); //0x18 = 24
...
0x234eac8c                        dd         menu_event_thread+1
	...
	//[2]
	{
		...
		0xffff, //uint16_t wData_2; //2
		{
			&menu_channel_list_graphic_items[7], //234ea7b8,
		}, //int fill_4[5]; //4
		0, //void (*initValueString)(struct Menu_Item*); //0x18 = 24
...
0x234eace4                        dd         menu_event_thread+1
	...
	//[4]
	{
		...
		0xffff, //uint16_t wData_2; //2
		{
			&menu_channel_list_graphic_items[9], //234ea838,
		}, //int fill_4[5]; //4
		0, //void (*initValueString)(struct Menu_Item*); //0x18 = 24
...
static Menu menu_channel_list = //234eadf8
{
    ...
    &menu_channel_list_items[0], //Menu_Item* Data_4; //4
    &menu_channel_list_items[0], //Menu_Item* Data_8; //8
    &menu_channel_list_graphic_items[1], //234ea638, //Struct_235fdf74_Inner12* header; //12 = 0xc
    0, /*&Data_234c3414*/ //Struct_235fdf74_Inner16* help; //16 = 0x10
    &menu_channel_list_graphic_data, //int graphicData; //20 = 0x14
...
/* /  / 23490bd0 - todo */
int menu_channel_list_entry(UI_Thread_Params* sp)
{
#if 1
	console_send_string("menu_channel_list_entry (todo.c): TODO\r\n");
#endif
