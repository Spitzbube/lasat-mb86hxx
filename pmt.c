...
/* 2344bba0 - todo */
int sub_2344bba0(uint8_t a, uint8_t* r5, int c, struct Struct_236001c8_Inner_0x14e0* r4, int r2)
{
#if 0
	console_send_string("sub_2344bba0 (todo.c): TODO\r\n");
#endif

#if 0
	{
		extern char debug_string[];
		sprintf(debug_string, "sub_2344bba0: r5[0]=0x%x\r\n",
				r5[0]);
	...
	case 0x52:
		...
		if (r2 != 0)
		{
			...
			{
				extern char debug_string[];
				sprintf(debug_string, "sub_2344bba0: r4->component_tag=%d\r\n",
						r4->component_tag);
				console_send_string(debug_string);
			}
#endif
...
static struct Struct_236001c8_Inner_0x14e0* func(struct Struct_236001c8* r6)
{
	for (uint8_t i = 0; i < 50; i++)
	{
		//loc_2344c1cc
		if (r6->Data_0x14e0[i].elementary_PID == 0)
		{
			return &r6->Data_0x14e0[i];
			//->loc_2344c208
		}
	}
	//0x2344c204
...
int pmt_decode_section(uint8_t a, uint8_t* b)
{
	...
	struct Struct_236001c8_Inner_0x14e0* r0 = r6->Data_0x14dc;
	if (r0 != 0)
	{
		do
		{
		...
		memset(&r6->Data_0x14e0, 0, 0x2af8);
	...
	{
		//loc_2344c1c4
		struct Struct_236001c8_Inner_0x14e0* r5;
#if 0
		for (uint8_t r0 = 0; r0 < 50; r0++)
		{
			//loc_2344c1cc
			if (r6->Data_0x14e0[r0].elementary_PID == 0)
			{
				r5 = &r6->Data_0x14e0[r0];
				//->loc_2344c208
			}
		}
		//0x2344c204
		...
		{
			for (struct Struct_236001c8_Inner_0x14e0* r1 = r0->next; r1 != 0; )
			{
				//loc_2344c21c
				r0 = r1;
				r1 = r0->next;
		...
		{
			//loc_2344c27c
			sub_2344bba0(a, r4, fp, r5, r5->elementary_PID);
