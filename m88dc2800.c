...
/* 23402b6c - todo */
int M88DC2000SetChannel(/*Struct_235fdfac ???*/Struct_23491e28_Inner0* r4)
{
#if 0
	console_send_string("M88DC2000SetChannel (todo.c): TODO\r\n");
#endif
...
//		r4->bData_2 = (r4->bData_2 & 0xf7) | ((Data_23491e20->Data_0.bData_0x14 << 31) >> 28);
	...
	M88DC2000SetFreq(r4->frequency / 10);
...
/* 23402da0 - complete */
int M88DC2000GetSignalStrength(uint8_t* r4)
{
	int16_t r0;
	uint32_t res;

#if 0
	console_send_string("M88DC2000GetSignalStrength (todo.c): TODO\r\n");
#endif

	r0 = (Data_23491e20->Data_0x98->tuner_get_strength)(&Data_23491e20->Data_0x20);
...
int sub_23402df4()
{
	...
	if (mtt == TN_MONTAGE_TC2800)
	{
		Data_23491e20->Data_0x98 = &Data_23487cb0;
	}
	//loc_23402e38
	else if (mtt == TN_MONTAGE_TC3800)
	{
		//VDR110: 0xB5
...
/* 23402e68 - complete */
int M88DC2000Sleep(void)
{
#if 0
	console_send_string("M88DC2000Sleep (todo.c): TODO\r\n");
#endif

	(Data_23491e20->Data_0x98->tuner_sleep)(&Data_23491e20->Data_0x20);
...
/* 23402efe - complete */
int M88DC2000SetFreq(int a)
{
#if 1
	{
		extern char debug_string[];
		sprintf(debug_string, "M88DC2000SetFreq: a=%d\r\n", a);
		console_send_string(debug_string);
	}
#endif

	(Data_23491e20->Data_0x98->tuner_set)(&Data_23491e20->Data_0x20, a);
