...
void sub_2342e544(int r6, int b, int r5, int sp_0x20, int r7)
{
...
#if 0
	{
		...
		sprintf(debug_string, "sub_2342e544: r6=%d, b=%d, r5=%d, sp_0x20=%d, r7=%d\r\n",
				r6, b, r5, sp_0x20, r7);
	...
	for (r4 = 0; r4 < 17; r4++)
	{
		...
		{
			//0x2342e678
			console_send_string("sub_2342e544: r7 = 6, TODO!!!!!!");
		...
		else if (r7 == 2)
		{
			//0x2342e6ec
			int r1 = Data_235f34b4[r4].Data_0;
			int r3 = Data_235f34b4[r4].Data_4;
			int r2 = Data_235f34b4[r4].Data_8;

			r3 = r3 + r1;

			r1 = Data_235f34b4[r4].Data_0xc;
			...
			r2 = Data_235f34b4[r4].Data_0x10;
			r3 = Data_235f34b4[r4].Data_0x14;
			r1 = Data_235f34b4[r4].Data_0x18;

			r2 = r2 + r3;

			r3 = Data_235f34b4[r4].Data_0x1c;

			r1 = r1 + r2;
			r1 = r1 + r3;

			Data_235f34b4[r4].Data_0xc = r1;
		}
		//loc_2342e730
		int ip = 0xfe;
		int lr = 0xff;
...
void sub_2342e8d8(int r4, int r6, int r2, int r3, int sp_0x38_arg_8, int sl/*sp_0x38_arg_c*/, uint32_t r5/*sp_0x38_arg_10*/)
{
	...
	for (Data_234926d4/*r0*/ = 0; Data_234926d4 < Data_234926e8/*r7*/; Data_234926d4++)
	{
		...
		{
			//0x2342eadc
			int a = Data_235f34b4[Data_234926d0].Data_8;
			int b = Data_235f34b4[Data_234926d0].Data_0xc;
			int c = Data_235f34b4[Data_234926d0].Data_0x10;
			int d = Data_235f34b4[Data_234926d0].Data_0x14;
			Data_23492710 = a + (b << 8) + (c << 16) + (d << 24);
		}
		else
		{
			//loc_2342eaf8
			//int a = Data_235f34b4[Data_234926e8 - Data_234926d0].Data_8;
			//int b = Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0xc;
			//int c = Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0x10;
			//int d = Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0x14;
			Data_23492710 = Data_235f34b4[Data_234926e8 - Data_234926d0].Data_8 + 
				(Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0xc << 8) + 
				(Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0x10 << 16) + 
				(Data_235f34b4[Data_234926e8 - Data_234926d0].Data_0x14 << 24);
		}
		//0x2342eb1c
		if (r5 < 2)
		{
...
//		uint32_t fp = Data_23492718;
	...
	{
		//0x2342f070
		(*r6) += (3 << 4); //VERFILTERUP + VERFILTERON
