...
#define THREAD_PRIO_TS_RECORD               46
#define THREAD_PRIO_TS_PLAY					47
#define THREAD_PRIO_NETWORK_STREAMING		48
...
#define THREAD_STACK_SIZE_TS_PLAY			0x320
#define THREAD_STACK_SIZE_TS_RECORD			0x320
